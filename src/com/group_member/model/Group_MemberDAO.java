...
public class Group_MemberDAO implements Group_MemberDAO_interface {
	...
	private static final String KICKOUT__STMT = "DELETE from `group_member` where PAY_STATUS = 0 and GROUP_NO = ?";
	
	private static final String GET_COUNT = "SELECT COUNT(*) CNT from GROUP_MEMBER WHERE GROUP_NO = ?; ";
