...
<%-- 錯誤表列 --%>
<div class="container-fluid forum-body">
...
<div class="col col-md-4 shadow-none p-2 mb-2 forum-nav" style="padding:0; margin-top:5px;">	
	<ul class="nav nav-pills">
		...
		<li role="presentation" class="active"><a role="button" class="btn btn-outline-dark toggle" onclick="location.href='<%=request.getContextPath()%>/topic/topic.do?action=listArticles_ByTopicno_B&topicno=1'">電影情報</a></li>
		<li role="presentation"><a role="button" class="btn btn-outline-dark toggle" onclick="location.href='<%=request.getContextPath()%>/topic/topic.do?action=listArticles_ByTopicno_B&topicno=2'">劇情討論</a></li>
		<li role="presentation"><a role="button" class="btn btn-outline-dark toggle" onclick="location.href='<%=request.getContextPath()%>/topic/topic.do?action=listArticles_ByTopicno_B&topicno=3'">影城活動</a> </li>
...
<FORM METHOD="post" class="search-form" ACTION="<%=request.getContextPath()%>/front-end/article/article.do" name="form1">   
