...
<table>
	...
	<tr>
		<td><textarea name="content" rows="5" cols="73" maxlength="300">${reportCommentVO.content}</textarea></td>
	</tr>	
...
<center><input type="submit" value="送出新增" class="btn btn-outline-danger"></center></FORM>
</body>
