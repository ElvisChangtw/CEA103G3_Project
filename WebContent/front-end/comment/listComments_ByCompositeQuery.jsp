...
<html>
<head><title>複合查詢 - listComments_ByCompositeQuery.jsp</title>
...
<h4>
☆萬用複合查詢  - 可由客戶端 select_comment_page.jsp 隨意增減任何想查詢的欄位<br>
...
<table id="table-1">
	<tr><td>
		 ...
		 <img src="<%=request.getContextPath()%>/images/comment_images/back1.gif" width="100" height="32" border="0">回首頁</a></h4>
	</td></tr>
</table>
...
<table>
	...
	<c:forEach var="commentVO" items="${listComments_ByCompositeQuery}" begin="<%=pageIndex%>" end="<%=pageIndex+rowsPerPage-1%>">
		<tr align='center' valign='middle' ${(commentVO.commentno==param.commentno) ? 'bgcolor=#CCCCFF':''}><!--將修改的那一筆加入對比色而已-->
