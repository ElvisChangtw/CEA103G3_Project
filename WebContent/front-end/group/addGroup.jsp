...
<div class="container div-add">
	...
	<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/group/group.do" id="add-form" name="form1" class="card p-2">
		...
		<input type="submit" value="送出新增" class="btn btn-info" style="width:100%;font-weight: bold;">
	</FORM>
</div>
