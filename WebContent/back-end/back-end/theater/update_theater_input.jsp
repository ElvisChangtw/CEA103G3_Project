...
<title>廳院資料修改 - update_theater_input.jsp</title>
...
<table id="table-1">
	<tr><td>
		 <h3>廳院資料修改 - update_theater_input.jsp</h3>
...
<table>
	...
	<tr>
		<td>廳院名稱:</td>
		<td><input type="TEXT" name="theater_name" size="45" value="<%=theaterVO.getTheater_name()%>" /></td>
	</tr>
	<tr>
		<td>廳院種類:</td>
<%-- 		<td><input type="TEXT" name="theater_type" size="45"	value="<%=theaterVO.getTheater_type()%>" /></td> --%>
		<td>
